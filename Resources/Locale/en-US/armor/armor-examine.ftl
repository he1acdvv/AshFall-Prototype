...
armor-coefficient-value-increase = - [color=yellow]{$type}[/color] damage increased by [color=lightblue]{$value}%[/color].
armor-reduction-value-increase = - [color=yellow]{$type}[/color] damage increased by [color=lightblue]{$value}[/color].
